...
import HeaderMetro from "./header/HeaderMetro"
    ...
    return (
        <>
            ...
            <div className={`boxed_wrapper ltr${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {headerStyle == 'Metro' ? <HeaderMetro scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} handlePopup={handlePopup} isSidebar={isSidebar} handleSidebar={handleSidebar} /> : null}
